...
def render_consultation():
    ...
    if st.session_state.selected_topic and not st.session_state.question:
        st.session_state.question = f"I would like advice about {st.session_state.selected_topic.lower()}."
    ...
    if st.session_state.show_followups:
        ...
        topic = st.session_state.selected_topic or "General"
        ...
        if topic == "General":
            ...
            if "headache" in q:
                ...
                topic = "Better Sleep"
            elif "food" in q or "diet" in q or "nutrition" in q:
                topic = "Nutrition"

        submitted, answers = show_follow_up(topic)
